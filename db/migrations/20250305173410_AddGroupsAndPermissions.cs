    ...
    public partial class AddGroupsAndPermissions : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupPermission_User_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_GroupPermission_User_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserGroup_User_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_UserGroup_User_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new Guid("00000000-0000-0000-0000-000000000001"), "Training Section Team", "Training Section", null, null },
                    { 2, new Guid("00000000-0000-0000-0000-000000000001"), "Central Programs Team", "Central Programs", null, null },
                    { 3, new Guid("00000000-0000-0000-0000-000000000001"), "Sheriff Provincial Support Team", "Sheriff Provincial Support", null, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupPermission_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupPermission_UpdatedById",
                table: "GroupPermission",
                column: "UpdatedById");
